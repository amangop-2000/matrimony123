...
const Register=()=>{
    ...
    let formhandle=(e)=>{
        e.preventDefault()
        let payload={
            name,age,gen,rel,pro,loc,inte,abo,pass
        }
